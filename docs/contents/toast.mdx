...
```bash
npm install react-native-gesture-handler react-native-reanimated lucide-react-native
```
...
<ComponentPreview
  name='toast-gestures'
  description='Toast notifications that can be dismissed with swipe gestures'
/>
